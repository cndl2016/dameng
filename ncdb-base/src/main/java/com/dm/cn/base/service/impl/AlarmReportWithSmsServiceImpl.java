 ...
 */
@Service("AlarmReportWithSmsService")
public class AlarmReportWithSmsServiceImpl implements AlarmReportService {

    private static final Logger log = LoggerFactory.getLogger(AlarmReportWithSmsServiceImpl.class);
    ...
    private void doPostNew(String strUrl, String params) {
        ...
        try {
            ...
            log.error("短信告警通知发送失败:" + e.getMessage());
