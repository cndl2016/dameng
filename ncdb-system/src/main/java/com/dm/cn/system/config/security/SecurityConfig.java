package com.dm.cn.system.config.security;

import com.dm.cn.common.config.properties.CasProperties;
import com.dm.cn.system.config.security.filter.JwtAuthenticationTokenFilter;
import com.dm.cn.system.config.security.handle.AuthenticationEntryPointImpl;
import com.dm.cn.system.config.security.handle.CasAuthenticationSuccessHandler;
import com.dm.cn.system.config.security.handle.LogoutSuccessHandlerImpl;
import com.dm.cn.system.service.impl.CasUserDetailsServiceImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        if (!casProperties.isCasEnable()) {
            httpSecurity
                    // sonar扫描误判：CSRF禁用，因为不使用session cn
                    .csrf().disable()
                    // 认证失败处理类
