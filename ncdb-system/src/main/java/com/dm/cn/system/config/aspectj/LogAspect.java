package com.dm.cn.system.config.aspectj;
...
import com.dm.cn.common.enums.BusinessStatus;
import com.dm.cn.common.enums.HttpMethod;
import com.dm.cn.common.filter.PropertyPreExcludeFilter;
...
public class LogAspect {
    ...
    private void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult) {
        try {
            ...
            if (loginUser != null) {
                ...
                // 设置操作部门
                if(!ObjectUtils.isEmpty(loginUser.getSysUser()) && !ObjectUtils.isEmpty(loginUser.getSysUser().getDept())){
                    operLog.setDeptName(loginUser.getSysUser().getDept().getDeptName());
                }
            }
    ...
    private void setRequestValue(JoinPoint joinPoint, SysOperLog operLog, String[] excludeParamNames) {
        ...
        boolean flag = StringUtils.isEmpty(paramsMap) && (HttpMethod.PUT.name().equals(requestMethod) || HttpMethod.POST.name().equals(requestMethod));
        if (flag) {
            ...
            for (Object o : paramsArray) {
                if (StringUtils.isNotNull(o) && !isFilterObject(o)) {
                    try {
                        ...
                        log.error("argsArrayToString exception: {}", e);
                    }
                }
            }
        }
     ...
     *
     * @param excludeParamNames
     * @return {@link PropertyPreExcludeFilter}
     */
