                    ...
                    <el-row>
                      <el-col :span="24">
                        <div class="dp-info">
                          ...
                          <!-- 用户角色 -->
                          <span v-if="roleGroup == '超级管理员'"><img src="../../assets/images/home/user_admin.svg" alt="超级管理员"></span>
                          <span v-if="roleGroup == '普通角色'"><img src="../../assets/images/home/user_normal.svg" alt="普通角色"></span>
                          <span v-if="roleGroup == '只读角色'"><img src="../../assets/images/home/user_readonly.svg" alt="只读角色"></span>
                          <span class="dp-user" v-if="!['超级管理员','普通角色','只读角色'].includes(roleGroup)">{{roleGroup}}</span>
                        </div>
                      </el-col>
                      <!-- 手机号码 -->
                      <el-col :span="24">
...
function handleOpenChat() {
  window.open('/system/chat/ai/index','_blank')
}
