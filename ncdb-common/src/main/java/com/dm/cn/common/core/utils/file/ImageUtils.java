...
public class ImageUtils {
    ...
    public static byte[] readFile(String url) {
        InputStream in = null;
        try {
            if (url.startsWith(Constants.START_SYMBOL_URL)) {
                // 网络地址
                ...
                // 本机地址
                String localPath = InfoConfig.getProfile();
                String downloadPath = localPath + StringUtils.substringAfter(url, TokenConstants.RESOURCE_PREFIX);
